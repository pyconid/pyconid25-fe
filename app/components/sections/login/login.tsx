		...
		<div className="flex gap-x-2 items-start h-full">
			...
			<div className="w-full h-screen lg:w-1/2">
				<div className="flex flex-col shadow-2xl rounded-3xl relative w-full h-full">
					...
					<div className="flex flex-col items-center justify-center gap-y-2 mt-2 p-2">
						...
						<button
							type="button"
							className="bg-[#224083] w-75  sm:w-121 xl:w-152 h-12 font-sans  rounded-sm text-white font-semibold text-2xl mt-4 hover:cursor-pointer"
						>
							Login to Your Account
						</button>
						<div className="flex items-center w-75  sm:w-121 xl:w-152 h-7 mt-6">
