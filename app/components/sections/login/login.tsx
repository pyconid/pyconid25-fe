      ...
      <div className="w-full lg:w-1/2 h-[992px]">
        <div className="flex flex-col shadow-2xl rounded-3xl relative w-full h-full">
          <div className="flex justify-end">
            <div className="w-[186px] h-[60px]">
              <div className="flex bg-[#F27F20] items-center justify-center rounded-br-sm rounded-bl-3xl rounded-tl-sm rounded-tr-3xl text-white text-3xl font-bold font-display ">
                <div>Login</div>
              </div>
            </div>
          </div>
            ...
            <div className="flex justify-between gap-x-2 w-[300px]  sm:w-[484px] xl:w-[607px] mt-[65px] ">
              ...
              <div className="flex w-[170px] sm:w-[236px]  xl:w-[296px] h-[70px] items-center justify-center gap-x-1 sm:gap-x-2 bg-[#F1F1F1] rounded-sm p-2">
                <img
                  ...
                  className="sm:w-[15px] sm:h-[15px] xl:w-[30px] xl:h-[30px]"
                ></img>
